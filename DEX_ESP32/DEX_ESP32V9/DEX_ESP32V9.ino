...
void DATA_store_calculateCRC(){
      ...
      if(flag=1){
        ...
        while(buff_flag == 0){
          ...
          if(DEXresponse != '' ){
            ...
            if(DEXresponse == '' ){buff_flag=1;}
            else if(DEXresponse == '' ){buff_flag=1; finalstate=1;Serial.println("si entre 1");}
          }
        }
      ...
      if(flag=1){
        ...
        while(buff_flag == 0){
          ...
          if(DEXresponse != '' ){
            ...
            if(DEXresponse == '' ){buff_flag=1;}
            else if(DEXresponse == '' ){buff_flag=1; finalstate=1; Serial.println("si entre");}
          }
        }
  ...
  flag=0;
  control_flag=1;
  Serial.println("Termine este hanshake de datos");
}
