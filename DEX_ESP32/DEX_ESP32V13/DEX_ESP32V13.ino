...
void send_to_web(){
  ...
  if (!client.connect(server, 807))
    ...
    // Make a HTTP request:
    client.println("GET /WebServiceTestAppVending.asmx/SendTestDataDEX?identifier="+ESP_identifier+"&dataDex="+FinalData+" HTTP/1.1");
    //client.println("GET /WebServiceTestAppVending.asmx/SendTestDataDEX?identifier=Braulio&dataDex=12345 HTTP/1.1");
